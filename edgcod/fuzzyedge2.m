function [Ieval2,Irgb]=fuzzyedge2(Irgb)

% Import RGB Image and Convert to Grayscale
Irgb = imread('zelda.png');
% Irgb = imnoise(Irgb,'gaussian',0,0.001);
...
Ieval2 = zeros(size(I));% Preallocate the output matrix
for ii = 1:size(I,1)
...
figure; image(Ieval2,'CDataMapping','scaled'); colormap('gray');
