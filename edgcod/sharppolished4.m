function [sharp,pic]=sharppolished4(pic)
% clear;clc;
% pre processing
...
figure;
imshow(sharp);title('Edges poisson');
figure('units','normalized','outerposition',[0 0 1 1])
imshow(pic2);title('RGB Smooth with medfilt2 and poisson Noise');
figure('units','normalized','outerposition',[0 0 1 1])
imshow(pic3);title('GrayScale Smooth and poisson Noise');
figure('units','normalized','outerposition',[0 0 1 1])
imshow(pic4);title('GrayScale Smooth with wiener2 and poisson Noise');
end
